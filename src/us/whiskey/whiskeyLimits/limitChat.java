...
public class limitChat {
    ...
    public static void broadcastMessage(String message) {
        message = limitChat.replaceColorCodes(message);
    ...
    public static void sendMessageToCommandSender(CommandSender sender, String message) {
        if(sender instanceof Player) {
            limitChat.sendMessageToPlayer((Player) sender, message);
        }
        else {
            limitChat.sendMessageToServer(message);
        }
    }
}
